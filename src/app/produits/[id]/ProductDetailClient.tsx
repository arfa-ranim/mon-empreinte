    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
      ...
      {images.length > 1 && (
        <div className="grid grid-cols-4 gap-3">
          {/* Show ALL images including the first, so the active one is highlighted */}
          {images.map((img, i) => (
            <button
              key={img}
              onClick={() => setCurrentImageIndex(i)}
              className={`relative aspect-square rounded-lg overflow-hidden bg-cream-100 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-peach-dark ${
                i === currentImageIndex
